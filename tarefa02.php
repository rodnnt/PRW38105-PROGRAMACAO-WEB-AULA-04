        ...
        <form method="POST">
            <div class="form-group">
                ...
                <div class="form-check">
                    <input type="radio" class="form-check-input" name="classificacao" id="muito-bom" required>
                    <label class="form-check-label" for="muito-bom">Muito bom</label>
                </div>
                <div class="form-check">
                    <input type="radio" class="form-check-input" name="classificacao" id="bom" required>
                    <label class="form-check-label" for="bom">Bom</label>
                </div>
                <div class="form-check">
                    <input type="radio" class="form-check-input" name="classificacao" id="regular" required>
                    <label class="form-check-label" for="regular">Regular</label>
                </div>
                <div class="form-check">
                    <input type="radio" class="form-check-input" name="classificacao" id="um-lixo" required>
